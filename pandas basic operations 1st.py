"""you are a data analyst working for an e-commerce company. The company has provided you with a dataset containing
information about customer orders. The dataset includes columns such as OrderID, CustomerID, ProductID, Quantity, and TotalPrice.
